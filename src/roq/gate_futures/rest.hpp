...
class Rest final : public web::rest::Client::Handler {
 ...
 protected:
  ...
  void operator()(Trace<json::OrderBook const> const &, std::string_view const &symbol);
 ...
 private:
  ...
  struct {
    core::metrics::Profile currencies, currencies_ack, contracts, contracts_ack, order_book, order_book_ack;
  } profile_;
  struct {
