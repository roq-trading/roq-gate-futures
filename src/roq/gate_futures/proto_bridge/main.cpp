...
#include "roq/gate_futures/proto_bridge/application.hpp"
...
auto const INFO = roq::Service::Info{
    .description = "Roq's Gate.io futures gateway (Protobuf interface)"sv,
...
int main(int argc, char **argv) {
  ...
  return roq::gate_futures::proto_bridge::Application{args, settings, INFO}.run();
}
