# [roq-gate-futures](https://roq-trading.com/docs/reference/gateways/crypto/roq-gate-futures/)

Roq's Gate.io futures gateway.
...
Reference documentation can be found [here](https://roq-trading.com/docs/reference/gateways/crypto/roq-gate-futures/).
